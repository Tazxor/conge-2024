...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Conges::class)]
    ...
    {
        return $this->email; // ou toute autre propriété que vous souhaitez utiliser comme chaîne de caractères
    }
}
